...
const BuyerBillDetail = () => {
    ...
    const fetchBuyerData = async () => {
        ...
        try {
            ...
            const data = await response.json();
            const requiredBuyer = data.find((buyer) => buyer._id === params.id)
            setAllBuyer(requiredBuyer);
        } catch (error) {
                    ...
                    <div className="w-full overflow-x-auto rounded-lg border bg-white border-gray-200">
                        ...
                        <div className='flex justify-start items-center px-4 py-2'>
                            <IoMdArrowBack
                                ...
                                size={'22px'}
                            />
                            <div className="flex gap-4 justify-between items-start px-4 ">
                                <span className="font-bold text-[16px]">BuyerBillDetail Details</span>
                            </div>
                        </div>
...
export default BuyerBillDetail;
